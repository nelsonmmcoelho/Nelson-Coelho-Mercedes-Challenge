...
public class MainTest {
    ...
    public static void main(String args[]) throws Exception {
        ...
        Assert.assertNotNull(driver.findElement(By.xpath("//button[contains(@class,'wb-button--accept-all')]"))); //assertain the existence of button "Agree to all"

        /* rom here now this code wasn't tested because of the cookie popup issue. As I spent a great deal of time of
        the challenge trying to solve this issue, I couldn't do the entire code of the challenge
        and the structure of the project isn't optimized as it should be.
